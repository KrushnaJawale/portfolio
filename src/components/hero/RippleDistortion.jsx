...
const MAX_WAVES = 30; // Reduced from 100
const QUALITY_SCALE = { low: 0.2, medium: 0.35, high: 0.5 }; // Drastically reduced
...
const RippleDistortion = ({
  ...
  useEffect(() => {
    ...
    // Skip on mobile if motion is reduced
    const reduceMotion =
    ...
    const renderer = new Renderer({
      alpha: false,
      antialias: false,
      dpr: isMobile ? 1 : Math.min(window.devicePixelRatio || 1, 1.5) // Lower DPR on mobile
    });
